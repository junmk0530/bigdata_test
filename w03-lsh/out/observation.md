...
- Confirmed quadratic scaling O(N²) for brute-force comparisons (jumping from 4,950 at N = 100 to nearly 2M comparisons at N = 2000).
...
- **Theoretical S-Curve Analysis**: The target Jaccard similarity threshold is s = 0.6. By setting b = 80 and r = 2, the theoretical S-curve crossover point is (1/b)^(1/r) = (1/80)^(1/2) ≈ 0.112. Setting this threshold significantly below 0.6 ensures high candidate capture probability for truly similar pairs.
